  ...
  return (
    <div className="space-x-1">
      ...
      <Button
        ...
        className={cn(
          "group relative inline-flex w-max items-center justify-center px-4 py-2 text-md font-semibold transition-colors disabled:pointer-events-none disabled:opacity-50 h-12 border border-border rounded-2xl cursor-pointer gap-1 hover:scale-100 focus:scale-100",
          open
            ? "bg-primary text-primary-foreground before:content-[ ] before:absolute before:w-full before:inset-0 before:-bottom-3 before:!-z-[1]"
        ...
        <div
          ...
          className={cn(
            ...
            open
              ...
              : "fade-out animate-out opacity-0 invisible",
