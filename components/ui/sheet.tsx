...
>(({ className, children, ...props }, ref) => (
  <SheetPrimitive.Close
    ref={ref}
    className={cn(
      "transition-opacity disabled:pointer-events-none data-[state=open]:bg-secondary size-12 border-2 border-foreground flex justify-center items-center rounded-full cursor-pointer",
      className
    )}
    {...props}
  >
...
>(({ side = "right", className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    <SheetPrimitive.Content
      ref={ref}
      className={cn(sheetVariants({ side }), className, "rounded-4xl")}
      {...props}
    >
      {children}
    </SheetPrimitive.Content>
